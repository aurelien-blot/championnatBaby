...
function creerEquipesetMajMatch($departIdEquipe, $departIdmatch, $tournoiX, $bdd){
    ...
    Tournoi::misAJourMatchPoule12($tournoiX->getIdCompet(), $iDe1, $bdd);
    ...
    $departIdmatch++;
    $insModifScore->closeCursor();
    Tournoi::misAJourMatchPoule12($tournoiX->getIdCompet(), $iDe3, $bdd);
    ...
    $departIdmatch++;
    $insModifScore->closeCursor();
    Tournoi::misAJourMatchPoule12($tournoiX->getIdCompet(), $iDe2, $bdd);
    ...
    $departIdmatch++;
    $insModifScore->closeCursor();
    Tournoi::misAJourMatchPoule12($tournoiX->getIdCompet(), $iDe4, $bdd);

    //MATCH 5
    $insModifScore = $bdd->prepare('UPDATE matchs SET vainqueur = :vainqueur, butEquipe1 = :butEquipe1, butEquipe2=:butEquipe2 WHERE id_Match = :id_Match');

    $insModifScore->execute(array(
        'vainqueur'=> intval($iDe6),
        'butEquipe1'=> intval(3),
        'butEquipe2'=> intval(2),
        'id_Match' => intval($departIdmatch)
    ));
    $departIdmatch++;
    $insModifScore->closeCursor();
    Tournoi::misAJourMatchPoule12($tournoiX->getIdCompet(), $iDe6, $bdd);
